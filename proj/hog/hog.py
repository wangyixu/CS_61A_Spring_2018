...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        gets_points = current_score - previous_score
        if gets_points > previous_high:
            if gets_points == 1:
                point = 'point!'
            else:
                point = 'points!'
            print(gets_points, point, "That's the biggest gain yet for Player", who)
            return announce_highest(who, gets_points, current_score)
        else:
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    "TODO"
    max_average_score, num_rolls = 0, 1
    roll = make_averaged(roll_dice, num_samples)
    for i in range(1, 11):
        average_score = roll(i, dice)
        if average_score > max_average_score:
            max_average_score, num_rolls = average_score, i
    return num_rolls
    # END PROBLEM 9
